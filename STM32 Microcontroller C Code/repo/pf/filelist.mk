...
# ONLY use relative file paths that start with $(SOURCELIB_ROOT)../
# DO NOT USE absolute file paths (e.g. /home/users/myuser/mydir)
LIBSRCS += $(MYLIB_PATH)/s4593321_CAG_simulator.c
LIBSRCS += $(MYLIB_PATH)/s4593321_CAG_display.c
LIBSRCS += $(MYLIB_PATH)/s4593321_CAG_grid.c
LIBSRCS += $(MYLIB_PATH)/s4593321_oled.c
LIBSRCS += $(MYLIB_PATH)/s4593321_lta1000g.c
LIBSRCS += $(MYLIB_PATH)/s4593321_user_button.c
LIBSRCS += $(MYLIB_PATH)/s4593321_CAG_Mnemonic.c
